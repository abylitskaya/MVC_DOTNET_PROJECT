    ...
    public partial class Migration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Tags_Id, t.News_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TagsNews", "News_Id", "dbo.News");
            DropForeignKey("dbo.TagsNews", "Tags_Id", "dbo.Tags");
            DropForeignKey("dbo.News", "ApplicationUser_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.TagsNews", new[] { "News_Id" });
            DropIndex("dbo.TagsNews", new[] { "Tags_Id" });
